...
Os planos de saúde frequentemente negam procedimentos alegando:
- Falta de cobertura (mesmo que prevista no contrato)
- Falta de atestação prévia inadequada
- Exclusão contratual improcedente
...
- Cópia da negativa formal do plano
- Contrato do plano de saúde
- Receita e prescrição médica
- Parecer da ANS (se houver reclamação anterior)
- Histórico de comunicação com o plano

### Passo 2: Solicite a Reconsideração Administrativa
Envie ao plano uma carta formal solicitando revisão da decisão:
- Cite a legislação aplicável (CDC, Lei 9.656/98, Resolução Normativa 514 da ANS)
- Apresente o parecer médico fundamentado
- Estabeleça prazo de 10 dias para resposta
- Envie por via que deixe rastreamento (AR, e-mail com comprovante)

### Passo 3: Protocole Reclamação na ANS
Se o plano não responder ou mantiver a negativa:
- Acesse www.ans.gov.br/consumidor
        tags: ['horas extras', 'cálculo trabalhista', 'direitos trabalhistas', 'adicional noturno'],
        relatedArticles: ['rescisao-contrato-trabalho-tipos-calculos-prazos', 'fgts-multa-40-saque-rescisao-guia-completo'],
        seoKeywords: ['horas extras', 'cálculo hora extra', 'adicional noturno', 'direitos CLT'],
        cta: 'Precisa de ajuda para calcular ou cobrar horas extras? Fale conosco via WhatsApp para uma análise gratuita.',

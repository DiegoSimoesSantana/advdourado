...
export default function AreasPage() {
  ...
  const visibleAreas = siteConfig.areas.filter((area) => priorityAreas.includes(area.id))
    ...
    <main className="min-h-screen bg-background px-4 py-14 sm:px-6 md:px-8">
      ...
      <div className="mx-auto max-w-6xl animate-fadein">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-foreground/75 animate-fadein delay-100">
          Selecione a área com maior proximidade com sua demanda. Em poucos passos, você entende o caminho da sua situação e pode falar diretamente com a Dra. Bruna para triagem inicial.
        </p>
